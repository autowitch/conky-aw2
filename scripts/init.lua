...
glue = require('./scripts/glue')

draw = require('./scripts/lib/draw')
conky_cfg = require('./scripts/lib/config')
widgets = require('./scripts/lib/widgets')
cache = require('./scripts/lib/cache')
